...
DEFAULT_CONFIG = {
    ...
    "param_B":
    64,  # a fixed block size, process B identifiers at a time and pack them into one ciphertext d
    "param_b":
    64,  # store encrypted blocks of b pointers to these encrypted blocks
...
class PiPtrConfig(SSEConfig):
    __slots__ = [
        "param_lambda", "param_B", "param_b", "prf_f_output_length",
